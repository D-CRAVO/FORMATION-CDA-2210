...
namespace Emprunts
{
    public partial class Emprunts : Form
    {
        ...
        private void initialisationDepart(uint _capitalEmprunte, double _tauxAnnuel, int _nbMois, string _periodicite)
        {
            ...
            etude = new Emprunts(_capitalEmprunte, _tauxAnnuel, _nbMois, _periodicite);
        }
        ...
        private void listBoxPeriodicite_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ihm(etude.capitalEmprunte, etude.tauxAnnuel, etude.nbMois, _periodicite);
        }

        private void buttonOk_Click(object sender, EventArgs e)
        {

            ihm(etude.capitalEmprunte, etude.tauxAnnuel, etude.nbMois, etude.periodicite);
        }

        private void radioButton7_CheckedChanged(object sender, EventArgs e)
        {
            double _tauxAnnuel = determinationTauxSaisi();
            ihm(etude.capitalEmprunte, _tauxAnnuel, etude.nbMois, etude.periodicite);
        }
        ...
        private void textBoxCapitalEmprunte_TextChanged(object sender, EventArgs e)
        {
            ...
            ihm(_capitalEmprunte, etude.tauxAnnuel, etude.nbMois, etude.periodicite);
        }
        ...
        private void hScrollBar_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            textBoxDuree.Text = _nbMois.ToString();
            ihm(etude.capitalEmprunte, etude.tauxAnnuel, _nbMois, etude.periodicite);
        }
    }
}
