...
namespace VoitureCodage
{
    internal class program
    {
        static void Main(string[] args)
        {
            ...
            //bool result17 = moteurDefaut.Eteindre(); // false
            //bool result18 = moteurDefaut.EntrainerRoues(roue1, roue2); // false
            //bool result19 = moteurDefaut.ArreterRoues(roue1, roue2); // false
            //bool result20 = moteurDefaut.Demarrer(); // true
            //bool result21 = moteurDefaut.Demarrer(); // false
            //bool result22 = moteurDefaut
