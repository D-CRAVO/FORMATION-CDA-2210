...
namespace VoitureCodage
{
    public class Voiture
    {
        ...
        public Voiture(string _marque, Moteur _moteur, Roue _roueAvd, Roue _roueAvg, Roue _roueArd, Roue _roueArg)
        {
            marque = _marque;
            moteur = new Moteur(_moteur);
            roues.Add("avd", new Roue(_roueAvd));
            roues.Add("avg", new Roue(_roueAvg));
            roues.Add("ard", new Roue(_roueArd));
            roues.Add("arg", new Roue(_roueArg));
        }
        ...
        /// <summary>
        /// Constructeur par copie avec dépendance de Voiture
        /// </summary>
        /// <param name="_nouvelleVoiture">Voiture à copier</param>
        public Voiture(Voiture _nouvelleVoiture) : this
            (
                _nouvelleVoiture.marque,
                _nouvelleVoiture.moteur.carburant,
                _nouvelleVoiture.moteur.enMarche,
                _nouvelleVoiture.roues["avd"].Diametre,
                _nouvelleVoiture.roues["avd"].Tourne
            )
        {
        }
