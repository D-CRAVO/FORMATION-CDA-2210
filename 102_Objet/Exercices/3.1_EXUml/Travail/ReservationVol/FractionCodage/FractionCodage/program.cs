    ...
    internal class program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                Fraction oppose = fraction05.Oppose(); // -4/7
                Fraction inverse = fraction05.Inverse(); // 7/4
                ...
                Fraction estDivise = fraction11.Divise(fraction12);

                Fraction estAdditionne3 = fraction11 + fraction12; // 0
                Fraction estSoustrait3 = fraction11 - fraction12; // 1
                Fraction estMultiplie3 = fraction11 * fraction12; // -1/4
                Fraction estDivise3 = fraction11 / fraction12; // -1
            }
            catch (Exception e)
            {
